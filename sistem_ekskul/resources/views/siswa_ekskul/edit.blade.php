    ...
    <div class="col-lg-8">
        <div class="modern-card" data-aos="fade-up">
            ...
            <div class="card-body p-4">
                <form action="{{ route('siswa_ekskul.update', $siswa->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group-modern">
                        ...
                        <select name="pilihan_ekskul" class="form-control-modern @error('pilihan_ekskul') is-invalid @enderror">
                            <option value="Pramuka" {{ old('pilihan_ekskul', $siswa->pilihan_ekskul) == 'Pramuka' ? 'selected' : '' }}>
                                Pramuka
                            </option>
                            <option value="Kesenian" {{ old('pilihan_ekskul', $siswa->pilihan_ekskul) == 'Kesenian' ? 'selected' : '' }}>
                                Kesenian
                            </option>
                            <option value="Olahraga" {{ old('pilihan_ekskul', $siswa->pilihan_ekskul) == 'Olahraga' ? 'selected' : '' }}>
                                Olahraga
                            </option>
                        </select>
                    ...
                    <div class="form-group-modern">
                        ...
                        <select name="hari_latihan" class="form-control-modern @error('hari_latihan') is-invalid @enderror">
                            <option value="Senin" {{ old('hari_latihan', $siswa->hari_latihan) == 'Senin' ? 'selected' : '' }}>Senin</option>
                            <option value="Selasa" {{ old('hari_latihan', $siswa->hari_latihan) == 'Selasa' ? 'selected' : '' }}>Selasa</option>
                            <option value="Rabu" {{ old('hari_latihan', $siswa->hari_latihan) == 'Rabu' ? 'selected' : '' }}>Rabu</option>
                            <option value="Kamis" {{ old('hari_latihan', $siswa->hari_latihan) == 'Kamis' ? 'selected' : '' }}>Kamis</option>
                            <option value="Jumat" {{ old('hari_latihan', $siswa->hari_latihan) == 'Jumat' ? 'selected' : '' }}>Jumat</option>
                            <option value="Sabtu" {{ old('hari_latihan', $siswa->hari_latihan) == 'Sabtu' ? 'selected' : '' }}>Sabtu</option>
                        </select>
                        @error('hari_latihan')
                            <div class="invalid-feedback-custom">
                                <i class="fas fa-exclamation-circle"></i> {{ $message }}
                    ...
                    <div class="form-group-modern">
                        ...
                        <select name="status_keaktifan" class="form-control-modern @error('status_keaktifan') is-invalid @enderror">
                            <option value="1" {{ old('status_keaktifan', $siswa->status_keaktifan) == 1 ? 'selected' : '' }}>Aktif</option>
                            <option value="0" {{ old('status_keaktifan', $siswa->status_keaktifan) == 0 ? 'selected' : '' }}>Tidak Aktif</option>
                        </select>
